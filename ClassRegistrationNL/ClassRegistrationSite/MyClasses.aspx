<%@ Page Title="" Language="C#" MasterPageFile="~/ClassRegistrationSite.Master" AutoEventWireup="true" CodeBehind="MyClasses.aspx.cs" Inherits="ClassRegistrationSite.WebForm5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainWindow" runat="server">
    
    <asp:Label ID="Label2" runat="server">My Classes:</asp:Label>
    <br />
    <br />
